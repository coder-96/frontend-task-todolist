...
export default function App() {
    ...
    // const [notagreement, setNotagreement] = useState(false);

    // const handleChangeFromUnDone = () => {
    //     setNotagreement(!notagreement);
    //     console.log(notagreement);
    // };

    // function handleData(newData) {
    //   if (agreement === true) {
    //     newData.filter(todo => todo.done === true)
    //   } else if(notagreement === true) {
    //     newData.filter(todo => todo.done === false)
    //   }
    ...
    return (
        <div className="bg-c3 rounded-lg mx-auto my-20 py-12 w-1/2 h-1/2 text-center">
            <p className="text-c2 pb-8">
                Приложение для хранения списка ежедневных задач
            </p>
            <hr className=""></hr>
            ...
            {/* <input
                className="bg-c2 w-30 rounded-full p-2 m-2 hover:bg-c1"
                type="button"
                value="выполнен"
            ...
            <input
                ...
                type="button"
                value="не выполнен"
                onClick={handleChangeFromUnDone}
            /> */}
            <section>
                <input
                            ...
                            return (
                                <div key={id} className="px-5 grid grid-cols-8">
                                    <li
                                        className={
                                            item.done
                                                ? "line-through decoration-c3 col-span-7 text-c2"
                                                : "col-span-7"
                                        }
